/******************************************************************************
* FILE: mpi_solved4.c
* Comment: The MPI_Reduce operation was done only by the non-MASTER track, while it should be done by all the tasks. The bug is solved by making also the MASTER task doing such operation. 
******************************************************************************/
#include "mpi.h"
#include <stdio.h>
#include <stdlib.h>
